...
export const BERUFSERLAUBNIS_INFO = {
    de: {
      ...
      process: {
        title: "Ablauf zur Erlangung der Berufserlaubnis:",
        steps: [
          {
          ...
          {
            title: "Antragstellung bei der zuständigen Behörde",
            description: [
              "Der Antrag wird bei der jeweiligen Landesbehörde oder Ärztekammer eingereicht. Eine individuelle Beratung kann den Prozess erleichtern."
            ]
          },
          {
            title: "Erteilung der vorübergehenden Arbeitserlaubnis",
            description: [
              "Nach erfolgreicher Prüfung des Antrags wird die Erlaubnis erteilt, die es ermöglicht, unter ärztlicher Aufsicht in Kliniken oder Praxen zu arbeiten."
            ]
          },
          {
    ...
    uk: {
      ...
      process: {
        title: "Етапи отримання дозволу на здійснення лікарської діяльності:",
        steps: [
          {
          ...
          {
            title: "Подача заяви до компетентного органу",
            description: [
              "Заяву подають до відповідного державного органу або лікарської палати. Консультації з фахівцями можуть допомогти уникнути помилок."
            ]
          },
          {
          ...
          {
            title: "Термін дії дозволу",
            description: [
              "Зазвичай дозвіл видається на термін до двох років і використовується як перехідний етап до отримання повної аппробації."
            ]
          },
          {
    ...
    fr: {
      ...
      process: {
        title: "Étapes pour obtenir l’autorisation d’exercice:",
        steps: [
          {
    ...
    es: {
      ...
      process: {
        title: "Pasos para obtener el Permiso de Ejercicio:",
        steps: [
          {
    ...
    pl: {
      ...
      process: {
        title: "Kroki do uzyskania pozwolenia na wykonywanie zawodu:",
        steps: [
          {
