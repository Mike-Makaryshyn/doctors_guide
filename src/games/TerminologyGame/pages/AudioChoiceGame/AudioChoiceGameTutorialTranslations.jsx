...
import tutorialTranslations from "./AudioChoiceGameTutorialTranslationsData";
import useGetGlobalInfo from "../../../../hooks/useGetGlobalInfo";
import styles from "./AudioChoiceGameTutorial.module.scss";

const AudioChoiceGameTutorial = ({ run, onFinish }) => {
  ...
  const handleJoyrideCallback = (data) => {
    ...
    if (status === STATUS.FINISHED || status === STATUS.SKIPPED) {
      ...
      localStorage.setItem("audioChoiceGameTutorialCompleted", "true");
    }
  };
...
export default AudioChoiceGameTutorial;