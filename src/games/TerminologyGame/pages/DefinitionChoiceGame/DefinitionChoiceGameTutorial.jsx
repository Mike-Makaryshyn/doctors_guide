...
import tutorialTranslations from "./DefinitionChoiceGameTutorialTranslations";
import useGetGlobalInfo from "../../../../hooks/useGetGlobalInfo";
import styles from "./DefinitionChoiceGameTutorial.module.scss";

const DefinitionChoiceGameTutorial = ({ run, onFinish }) => {
  ...
  useEffect(() => {
    const stepsData = [
      {
        // Vступний крок – не прив'язаний до жодного елементу
        target: "body",
  ...
  const handleJoyrideCallback = (data) => {
    ...
    if (status === STATUS.FINISHED || status === STATUS.SKIPPED) {
      ...
      localStorage.setItem("definitionChoiceGameTutorialCompleted", "true");
    }
  };
...
export default DefinitionChoiceGameTutorial;