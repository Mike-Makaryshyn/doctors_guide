export const strokeMindMap = {
  id: "stroke",
  label: "Formen des Schlaganfalls",
  children: [
    {
      id: "ischämisch",
    ...
    },
    {
      ...
      children: [
        {
          id: "inzidenz",
          label: "270.000 Schlaganfälle/Jahr"
        },
        {
          id: "rate",
          label: "250/100.000 Einwohner/Jahr"
        },
        {
          id: "anteil",
          label: "80–85% ischämisch"
        },
        {
          id: "behinderung",
          label: "Ca. 700.000 Menschen behindert"
        }
      ]
    },
    {
      ...
      children: [
        {
          id: "kardiale1",
          label: "Kardiale Embolien"
        },
        {
          id: "kardiale2",
          label: "Thromboembolien (z.B. Vorhofflimmern)"
        },
        {
          id: "atherosklerose1",
          label: "Atherosklerose: Makroangiopathie"
        },
        {
          id: "atherosklerose2",
          label: "Mikroangiopathie"
        },
        {
          id: "dissektion",
          label: "Dissektion: Karotis & Vertebralis"
        },
        {
          id: "weitere_ursachen",
          label: "Zerebrale Vaskulitis, Thrombophilien"
        }
      ]
    },
    {
      ...
      children: [
        {
          id: "symptome",
          label: "Symptome: Hemiparese, Aphasie, etc."
        },
        {
          id: "untersuchung",
          label: "Untersuchung: FAST, NIHSS"
        }
      ]
    },
    {
